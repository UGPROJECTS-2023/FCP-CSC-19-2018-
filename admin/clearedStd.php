...
$DeanFaculty= isset($_POST['faculty']) ? $_POST['faculty'] : $_SESSION['faculty'];
if (isset($_GET['id'])) {
	$Code =$_GET['id'];
...
<?php
$sql=mysqli_query($db,"SELECT * FROM mainclearance WHERE CoordinatorStatus='Accepted' AND lvlCoordinatorStatus='Accepted' AND sCoordinatorStatus='Accepted' AND HoDStatus='Accepted' AND pCoordinatorStatus='Accepted' AND lTechnicianStatus='Accepted'");
$count=1;
...
<!-- <button onclick="window.Print()">print</button>
 -->
<a class="btn btn-default btn-lg btn-block" href="#">Copyright &copy; 2023 Federal University, Dutse </a>
                                    </div>
                                </div>
                                <!-- /.panel-body -->
                            </div>
