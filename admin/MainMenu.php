...
<head>
    ...
    <link rel="shortcut icon" type="img/jpeg" href="logo.jpeg">
    <!-- Bootstrap Core CSS -->
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                    <a href="addStudent.php"><i class="glyphicon glyphicon-plus"></i>	Register Student </a>
                                    </li>
                                    <li>
                    ...
                    <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="AddUser.php"><i class="glyphicon glyphicon-plus" ></i> Add Admin User</a>
                                    </li>
                                    <li>
                                        <a href="ManageUsers.php"><i class="fa fa-users fa-fw"> </i> Manage Admin Users</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
