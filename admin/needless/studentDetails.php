...
<?php 
  ...
  <tr>
				<td colspan="2" align="left"  class="heading" style="color: red; font-size:20px">Personal Info &raquo; </td>
			</tr>
			<tr>
	<td colspan="2"  class="font"><?php echo ucfirst($row['StudentName']);?><span class="font1"> &raquo;</span> </td>
  </tr>
...
<tr>
<td width="12%" valign="top" class="heading">Course Duration: </td>
<td class="comb-value1"><?php echo $row['Year_Of_Study'];?></td>
</tr>

<tr>
<td width="12%" valign="top" class="heading">Email: </td>
<td class="comb-value1"><?php echo $row['AppliedOn'];?></td>
</tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="35%" class="comb-value"><label>
            <input name="Submit" type="submit" class="txtbox4" value="Print" onClick="return f3();" />
          </label></td>
          <td width="3%">&nbsp;</td>
          <td width="26%"><label>
