...
<?php
$result ="SELECT * FROM mainclearance  where CoordinatorStatus='' OR lvlCoordinatorStatus='' OR sCoordinatorStatus='' OR
HoDStatus='' OR pCoordinatorStatus='No respond yet' OR lTechnicianStatus='' ";
...
<a class="btn btn-default btn-lg btn-block" href="#"><center>All Rights Reserved @ FUD 2024</center></a>
                                    </div>
                                </div>
                                <!-- /.panel-body -->
                            </div>
