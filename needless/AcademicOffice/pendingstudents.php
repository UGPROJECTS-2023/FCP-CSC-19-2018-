...
<?php
$result ="SELECT * FROM mainclearance  WHERE BursarStatus='No respond yet' or 
...
<a class="btn btn-default btn-lg btn-block" href="#"><center>Copyright &copy; 2021 Bayero University, Kano</center></a>
                                    </div>
                                </div>
                                <!-- /.panel-body -->
                            </div>
