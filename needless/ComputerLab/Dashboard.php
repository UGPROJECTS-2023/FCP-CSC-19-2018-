 ...
 <!-- Page Content -->
    <div id="page-wrapper" style="color:#6b0d00;">
        <div class="container-fluid">
		  ...
		  <div class="panel-heading">Computer Lab Dashboard Analysis OverView</div>
...
<div class="row">
  <div class="col-sm-6 col-md-4" >
    <div class="thumbnail" style="background-color:  #6b0d00; color: #ffffff; border-radius : 25px;">
    	<center>
 <?php
$result ="SELECT count(*) FROM mainclearance  WHERE ComputerLabStatus='Accepted' ";
...
<center>
        ...
        <?php
$result ="SELECT count(*) FROM mainclearance WHERE ComputerLabStatus = 'No respond yet'";
$stmt = $db->prepare($result);
$stmt->execute();
$stmt->bind_result($count);
$stmt->fetch();
...
<div class="caption">
  ...
  <div class="col-sm-6 col-md-4" >
    <div class="thumbnail" style="background-color: #00331a; color: #ffffff; border-radius : 25px;">
    	<center>
 <?php
$result ="SELECT count(*) FROM mainclearance  WHERE ComputerLabStatus='Declined' ";
$stmt = $db->prepare($result);
$stmt->execute();
$stmt->bind_result($count);
$stmt->fetch();
...
<p class="stat-panel-number h1 "><?php echo $count;?></p>
      ...
      <div class="caption">
        ...
        <p> <a href="Declinedstudents.php" style="color: white; ">View Details</a></p>
		    ...
		    <div class="panel-footer">Computer Lab OverView </div>		
			</div>  
	   </div>
        <!-- end of container -->