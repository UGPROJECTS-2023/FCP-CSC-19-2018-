        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
					  <li><a href="#">Chemistry Laboratory</a></li>
		  ...
		  <div class="panel-heading">Chemistry Laboratory Dashboard Analysis OverView</div>
...
<div class="row">
  <div class="col-sm-6 col-md-4" >
    <div class="thumbnail" style="background-color:  #6b0d00; color: #ffffff; border-radius : 25px;">
    	<center>
 <?php
$result ="SELECT count(*) FROM mainclearance  WHERE (ChemistryLabStatus='Accepted' AND Faculty!='fcsit')";
...
<center>
        ...
        <?php
$result ="SELECT count(*) FROM mainclearance WHERE (ChemistryLabStatus = 'No respond yet' AND Faculty!='fcsit')";
$stmt = $db->prepare($result);
$stmt->execute();
$stmt->bind_result($count);
$stmt->fetch();
...
<div class="caption">
  ...
  <div class="col-sm-6 col-md-4" >
    <div class="thumbnail" style="background-color: #00331a; color: #ffffff; border-radius : 25px;">
    	<center>
 <?php
$result ="SELECT count(*) FROM mainclearance  WHERE (ChemistryLabStatus='Declined' AND Faculty!='fcsit')";
$stmt = $db->prepare($result);
$stmt->execute();
$stmt->bind_result($count);
$stmt->fetch();
...
<p class="stat-panel-number h1 "><?php echo $count;?></p>
      ...
      <div class="caption">
        ...
        <p> <a href="Declinedstudents.php" style="color: white; ">View Details</a></p>
		    ...
		    <div class="panel-footer">Chemistry Laboratory OverView </div>		
			</div>  
	   </div>
        <!-- end of container -->