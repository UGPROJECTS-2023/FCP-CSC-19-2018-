        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
					  <li><a href="#">Security Department</a></li>
		  ...
		  <div class="panel-heading">Security Department Dashboard Analysis OverView</div>
...
<div class="row">
  <div class="col-sm-6 col-md-4" >
    <div class="thumbnail" style="background-color:  #6b0d00; color: #ffffff; border-radius : 25px;">
    	<center>
 <?php
$result ="SELECT count(*) FROM mainclearance  WHERE SecurityStatus ='Accepted' ";
...
<center>
        ...
        <?php
$result ="SELECT count(*) FROM mainclearance WHERE SecurityStatus = 'No respond yet'";
$stmt = $db->prepare($result);
$stmt->execute();
$stmt->bind_result($count);
$stmt->fetch();
...
<div class="caption">
  ...
  <div class="col-sm-6 col-md-4" >
    <div class="thumbnail" style="background-color: #00331a; color: #ffffff; border-radius : 25px;">
    	<center>
 <?php
$result ="SELECT count(*) FROM mainclearance  WHERE SecurityStatus ='Declined' ";
$stmt = $db->prepare($result);
$stmt->execute();
$stmt->bind_result($count);
$stmt->fetch();
