...
<?php
$sql=mysqli_query($db,"SELECT * FROM mainclearance where lTechnicianStatus ='Accepted' AND HodStatus='Accepted' AND lvlCoordinatorStatus='Accepted';");
$count=1;
...
<tbody>
	<tr>
		...
		<td><?php echo $rows['lTechnician_Cleared_By'];?></td>
    </tr>
</tbody>
<?php $count=$count+1;} ?>
 </table>
