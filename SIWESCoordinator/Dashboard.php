        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
					  <li><a href="#">SIWES Coordinator</a></li>
		  ...
		  <div class="panel-heading">SIWES Coordinator Dashboard Analysis OverView</div>
...
<div class="row">
  <div class="col-sm-6 col-md-4" >
    <div class="thumbnail" style="background-color:  #6b0d00; color: #ffffff; border-radius : 25px;">
    	<center>
 <?php
$result ="SELECT count(*) FROM mainclearance  WHERE sCoordinatorStatus='Accepted' ";
...
<center>
        ...
        <?php
$result ="SELECT count(*) FROM mainclearance WHERE sCoordinatorStatus = 'No respond yet' AND HoDStatus = 'Accepted'";
$stmt = $db->prepare($result);
$stmt->execute();
$stmt->bind_result($count);
$stmt->fetch();
...
<div class="caption">
  ...
  <div class="col-sm-6 col-md-4" >
    <div class="thumbnail" style="background-color: #00331a; color: #ffffff; border-radius : 25px;">
    	<center>
 <?php
$result ="SELECT count(*) FROM mainclearance  WHERE sCoordinatorStatus='Declined' ";
$stmt = $db->prepare($result);
$stmt->execute();
$stmt->bind_result($count);
$stmt->fetch();
...
<p class="stat-panel-number h1 "><?php echo $count;?></p>
      ...
      <div class="caption">
        ...
        <p> <a href="Declinedstudents.php" style="color: white; ">View Details</a></p>
		    ...
		    <div class="panel-footer">SIWES Coordinator OverView </div>		
			</div>  
	   </div>
        <!-- end of container -->