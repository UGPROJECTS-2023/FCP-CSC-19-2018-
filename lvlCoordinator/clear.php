...
$fullname= isset($_POST['fname']) ? $_POST['fname'] : $_SESSION['fname'];
 if (isset($_POST['Submit'])) {
	...
	$result="UPDATE mainclearance SET lvlCoordinatorStatus ='$clstatus', lvlCoordinator_Cleared_By='$clearedby' WHERE RegNo='$rowInfo'";
...
<div id="page-wrapper">
    ...
    <form action="" method="POST">
      ...
      <select name="dept" class="form-control" required readonly>
			<option value="bursary Office" selected>Level Coordinator Office</option>
        </select>
        <br/>
