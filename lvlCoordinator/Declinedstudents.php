...
if(isset($_GET['rowId'])){
	$rowInfo=$_GET['rowId'];
	$result="UPDATE mainclearance SET lvlCoordinatorStatus ='Accepted', lvlCoordinator_Cleared_By='$fullname' WHERE RegNo='$rowInfo'";
	$sql=mysqli_query($db,$result);
}

if(isset($_GET['rowId2'])){
	$rowInfo=$_GET['rowId2'];
	$result="UPDATE mainclearance SET lvlCoordinatorStatus ='Declined', lvlCoordinator_Cleared_By='$fullname' WHERE RegNo='$rowInfo'";
	$sql=mysqli_query($db,$result);
...
<div id="page-wrapper">
 ...
 <div class="row">
 <div class="col-lg-12">
 <h1 class="page-header">Declined Students  </h1>
</div>
</div>
                    <!-- /.row -->
<div class="row">
...
<?php
$sql=mysqli_query($db,"SELECT * from mainclearance where  lvlCoordinatorStatus ='Declined';");
$count=1;
