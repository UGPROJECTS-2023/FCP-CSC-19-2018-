...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation"  style="background:#6b0d00;">
        ...
        <a href="#"><i class="glyphicon glyphicon-th-list"></i> Requirements<span class="fa arrow"></span></a>
                            ...
                            <li>
                        <a href="AllAppliedStudents.php"><i class="fa fa-users"></i>   All Applied Students</a>
                    </li>
                            <li>
                        <a href="clearedStd.php"><i class="glyphicon glyphicon-ok"></i> Cleared Student</a>
                    </li>
                    <li>
                        <a href="Notification.php"><i class="glyphicon glyphicon-envelope"></i> Manage Notifications</a>
                    </li>
                </ul>
